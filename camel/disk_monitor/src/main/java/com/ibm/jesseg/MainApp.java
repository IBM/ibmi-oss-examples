...
public class MainApp {
    ...
    public static void main(final String... args) throws Exception {
        ...
        context.getRegistry().bind("jt400", new AS400JDBCDataSource("localhost", "*CURRENT", ""));
                ...
                from("timer://foo?period=5000").routeId("diskmon")
                    ...
                    .choice()
                        .when(body().isGreaterThan(90))
                            ...
                            .to("smtp://mysmtpserver:1025?from=me@gmail.com&to=me@gmail.com&subject=Disk getting full!!")
