...
/**
 * For main-line code, see the {@link MainApp} class. <br>
 * This is a convenience class centered around reading values from a
 * configuration file (config.properties). Subclasses can provide URIs
 * appropriate for establishing Camel routes. Properties can also be overridden
 * by Java system properties, for instance, specifying -Dprop=value on the
 * command line. <br>
...
class CamelConfig {
    ...
    /**
     * Whether the given property looks like a password property that should be
     * obfuscated
     *
    ...
    /**
     * Obfuscate the property value if the property itself looks like a password
     * property
     * 
     * @param _prop  the property name
     * @param _value the value of the property
     * @return the value of the property if obfuscation is not needed, otherwise an
     *         obfuscated form.
     */
     ...
     *
     * @param _prop the property
     * @return the user's input (may be empty string), or null if no input can be
     *         gathered
     * @throws IOException
     * @throws RuntimeException if we can't access the console to properly ask for
     *                          the password in a masked manner
     */
    ...
    /**
     * Returns the value for the given property. If the property is not set, the
     * given default is returned.
     * 
     * @param _prop    the property
     * @param _default the default value
     * @return the value for the given property. If the property is not set, the
     *         given default is returned.
     * @throws IOException
     */
    ...
    /**
     * Returns the given property. If the property is not set, the given default is
     * returned. If the _abortIfNoValueOrDefault parameter is true, then a
     * RuntimeException will be thrown if the property is not set and the default
     * value is null.
     * 
     * @param _prop                    the property's value
     * @param _default                 the default value
     * @param _abortIfNoValueOrDefault whether to abort (via a
     *                                 {@link RuntimeException}) if the value is not
     *                                 set and there is no default.
     * @return
     * @throws IOException
     */
    public synchronized String getProperty(final String _prop, final String _default,
            final boolean _abortIfNoValueOrDefault) throws IOException {
        if (null == m_props) {
            ...
            if (null == inputStream) {
                ...
                m_props.load(new BufferedReader(new InputStreamReader(inputStream, "UTF-8")));
            }
        }
        ...
        if (null == ret) {
            ...
            return (null == _default) ? null : _default;
        }
